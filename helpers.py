...
def is_path_exists_or_creatable(pathname: str) -> bool:
    ...
    :param pathname: the path to be tested for validity for creation
    :type pathname: str
    :return: `True` if the passed pathname is a valid pathname for the current OS _and_ either currently exists or is hypothetically creatable; `False` otherwise.
    :rtype: bool
    '''
    try:
...
def dump_objs(objects,name):
    '''
    Dumps processed dataframes to joblib objects
    '''
    
    objs = [object_to_dump for object_to_dump in objects]
    joblib.dump(objs,name)
